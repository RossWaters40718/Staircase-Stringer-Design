...
def on_resize(event):
    if event.widget == root:
        ...
        if event.width>=event.height:
            root_fontsize= int(event.height/(default_hgt/rootdefault_fontsize))
        else:
            root_fontsize= int(event.width/(default_wid/rootdefault_fontsize))
